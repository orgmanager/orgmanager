        ...
        <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
            <center>
                <table cellspacing="0" cellpadding="0" width="600" class="w320">
                    ...
                    <tr>
                        <td class="free-text">
                            Thank you for registering. We hope you enjoy your time with us. If you haven't yet, go
                            ahead, add an organization and make your future members' lives easier.
                        </td>
                    </tr>
                    <tr>
                        <td class="button">
                            <div><!--[if mso]>
                                ...
                                <![endif]--><a class="button-mobile" href="{{ url('dashboard') }}"
                                               style="background-color:#ff6f6f;border-radius:5px;color:#ffffff;display:inline-block;font-family:'Cabin', Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;line-height:45px;text-align:center;text-decoration:none;width:155px;-webkit-text-size-adjust:none;mso-hide:all;">Go
                                    to my Dashboard</a></div>
                        </td>
                    </tr>
                    <tr>
                        <td class="free-text">
                            Need anything? Have an idea? Want to say hello? Just reply to this email and a member of our
