...
<head>
    ...
    <title>You didn't finish your OrgManager setup!</title>
                                                ...
                                                <td class="progress-bar">
                                                    <table cellpadding="0" cellspacing="0" width="100%">
                                                        <tr>
                                                            ...
                                                            <!-- STEP ONE -->
                                                            <td class="step">
                                                                <img src="http://s3.amazonaws.com/swu-filepicker/0oYLLViRBKv7a0Lzh6vC_v3_03.jpg"
                                                                     alt="step one"/><br/>
                                                                Create Account
                                                            </td>
                                                            ...
                                                            <td class="step active">
                                                                <img src="http://s3.amazonaws.com/swu-filepicker/YL3H3V5bRyGuy6pess9T_v33_04.jpg"
                                                                     alt="step two"/><br/>
                                                                Add Organizations
                                                            </td>
                                                            ...
                                                            <!-- STEP THREE -->
                                                            <td class="step">
                                                                <img src="http://s3.amazonaws.com/swu-filepicker/YSTlgtgaTSa897tPTUhl_v3_05.jpg"
                                                                     alt="step three"/>
                                                                Share Links
                                                            </td>
                                            ...
                                            <tr>
                                                <td class="button">
                                                    <div><!--[if mso]>
                                                        ...
                                                        <![endif]--><a href="{{ url('sync') }}"
                                                                       style="background-color:#ff6f6f;border-radius:5px;color:#ffffff;display:inline-block;font-family:'Cabin', Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;line-height:45px;text-align:center;text-decoration:none;width:155px;-webkit-text-size-adjust:none;mso-hide:all;">Add
                                                            Organizations</a></div>
                                                </td>
                                            </tr>
                                        </table>
