        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                      ...
                      <form id="password" method="POST" href="{{ url('password/'.$org->id) }}">
                      {{ csrf_field() }}
                      <td><span class="octicon octicon-lock"></span><input type="text" name="password" class="password" value="{{ $org->password }}" placeholder="Protect the invites!"></td>
