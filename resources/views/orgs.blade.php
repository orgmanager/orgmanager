...
@section('content')
        ...
        <div class="flex items-center justify-center mt-8 w-full">
            <div class="bg-blue-lightest border-t-4 border-brand rounded-b text-teal-darkest px-4 py-3 shadow-md sm:w-1/2" role="alert">
                <div class="flex items-center">
                    ...
                    <p class="text-sm mt-1 leading-normal">Double check <a href="https://github.com/settings/connections/applications/{{ config('services.github.client_id') }}" class="no-underline text-inherit link-shadow link-transition" target="_blank" rel="noopener noreferrer">we have been given access to it</a> and then sync again.</p>
                    </div>
                </div>
            </div>
        </div>
