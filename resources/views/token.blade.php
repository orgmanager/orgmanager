        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                  ...
                  <input id="token" class="form-control text-center" type="text" disabled="disabled" value="{{ Auth::user()->api_token }}">
                  ...
                  <div class="flash flash-error text-center">
                    <h4>Danger zone:</h4> You should only use this option if your token security has been compromised. This will regenerate your token, and will cause all the applications using it to stop working.
                  </div>
                  <br>
                  ...
                  <form id="regenerate-token" method="POST">
                    {{ csrf_field() }}
                    {{ method_field('DELETE') }}
                    <button class="btn btn-danger text-center centered" type="submit">Regenerate token</button>
                  </form>
                  </div>
                </div>
            </div>
