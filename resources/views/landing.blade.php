    ...
    <div class="min-w-full min-h-screen flex items-center justify-center w-full px-2">
        ...
        <div class="flex-1 w-full mt-12 ">
            ...
            <div class="flex items-center justify-around">
                    ...
                    <a href="https://github.com/fossasia/orgmanager/" target="_blank" rel="noopener noreferrer" class="no-underline bg-black-light border-2 border-black-light hover:bg-white text-white hover:text-black-light font-bold py-2 px-6 self-stretch rounded-full">
        ...
        <footer class="w-full bg-white border-t border-dark-light h-24 flex items-center justify-around">
            ...
            <div>
                <a class="hidden sm:block text-black-light no-underline" href="https://github.com/fossasia/orgmanager/" target="_blank" rel="noopener noreferrer">
